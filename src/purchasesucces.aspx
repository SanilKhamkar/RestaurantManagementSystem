<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchasesucces.aspx.cs" Inherits="Restaurant.purchasesucces" %>
...
<body>
    ...
    <div class="right-layout">
        ...
        <div class="info">
            <!--Info Name Layout-->
            <div class="info-name">
                <h3><b>Purchase has been Placed</b></h3>
                <h4></h4>
            </div>
            ...
            <div class="info-details">
                <!--Form details Layout-->
                  <div class="signup">
                    <h6 style="margin-left: 1rem;">Go back to <a href="Purchase.aspx" style="color: springgreen;">Purchase page</a> .</h6>
                </div>
                <!--End of Form Layout-->
